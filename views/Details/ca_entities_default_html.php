		...
		<div class="container">
			<div class="row">
				...
				<div class='col-sm-8 col-md-8 col-lg-8'>
					{{{<ifdef code="ca_entities.biographist"><label>Bio</label>^ca_entities.biographist<br/></ifdef>}}}
				</div><!-- end col -->
			</div><!-- end row -->
			<div class="row">			
				<div class='col-sm-6 col-md-6 col-lg-6'>
					{{{<ifcount code="ca_objects" min="1" max="1"><div class='unit'><unit relativeTo="ca_objects" delimiter=" "><l>^ca_object_representations.media.medium</l><div class='caption'>Related Object: <l>^ca_objects.preferred_labels.name</l></div></unit></div></ifcount>}}}
<?php
