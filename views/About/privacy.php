<?php
	MetaTagManager::setWindowTitle($this->request->config->get("app_display_name").": Privacy");
?>
    ...
    <div class="container">
        ...
        <h1 class="text-center">Imagining Futures Privacy Policy</h1>
            ...
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to A. G. Leventis Digital Resource Centre for African Culture, Department of Archaeology and Heritage Studies University of Ghana.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Imagining Futures Repository, accessible from <a href="https://ifrepo.world" rel="external nofollow noopener" target="_blank">https://ifrepo.world</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: admin@ifrepo.world</li>
            </ul>

        </div><!-- end of policies-text -->
        </div> <!-- end of about -->
